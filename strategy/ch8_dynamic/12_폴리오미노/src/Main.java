/**
 * <a href="https://algospot.com/judge/problem/read/POLY">링크</a>
 * <p>
 * 문제
 ...
 *
 *
 * 예를 들어 그림 (a)는 정상적인 세로 단조 폴리오미노입니다.
 * 그러나 (b)는 점선이 폴리오미노를 두 번 교차하기 때문에 세로 단조 폴리오미노가 아닙니다.
 ...
 * 그 후 각 줄에 폴리오미노를 구성할 정사각형의 수 n (1≤n≤100)이 주어집니다.
 * <p>
 * 출력
